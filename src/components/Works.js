    ...
    <main>
      ...
      <div className='works-container'>
        <div className='work'>
          ...
          <a href='https://vjls-jh.com/' className='btn' target="_blank">See the site</a>
        </div>
        ...
        <div className='work'>
          ...
          <a href='https://chiaki-yamada.github.io/Interactive-Photo-Gallery/' className='btn' target="_blank">See the site</a>
        </div>
        ...
        <div className='work'>
          ...
          <a href='https://chiaki-yamada.github.io/employee-directory/' className='btn' target="_blank">See the site</a>
        </div>
